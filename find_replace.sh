...
#sed -i "s/myprojects/replace-with-another-projects-dir-name/g" setup.sh etc/apache2.conf scripts/django_projects.pth scripts/tail-logs.sh
#sed -i "s/mysite/replace-with-another-project-name/g" setup.sh scripts/django_projects.pth etc/apache2.conf scripts/tail-logs.sh
